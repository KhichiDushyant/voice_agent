...
urlpatterns = [
    ...
    path('api/appointments/', views.get_appointments, name='appointments_api'),
    path('api/appointments/<int:appointment_id>/', views.get_appointment, name='appointment_detail_api'),
